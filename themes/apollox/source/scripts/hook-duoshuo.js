...
var duoshuo_script = document.querySelector('#duoshuo-script');
typeof DUOSHUO !== 'undefined' ? hookTemplate() : (duoshuo_script && (duoshuo_script.onload = hookTemplate));
...
function getAgentInfo(str) {
  ...
  var osName = sua.getOS().name || UNKNOWN;
  var osVersion = sua.getOS().version  || UNKNOWN;
  var browserName = sua.getBrowser().name || UNKNOWN;
  var browserVersion = sua.getBrowser().version || UNKNOWN;
  var iconMapping = {
    os: {
      android : 'android',
      linux   : 'linux',
